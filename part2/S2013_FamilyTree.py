...
class Family(object):
    ...
    def cousin(self, a, b):
        ...
        r=0
        degree = 0
        parent_a = a.get_parent
        parent_b = b.get_parent

        if a == b:
            t = -1
        elif a.get_parent == b  or b.get_parent == a:
            t = -1
        if parent_a == parent_b:
            t = 0
            r =0
        else:
            grand_a = parent_a.get_parent
            grand_b = parent_b.get_parent
            if grand_a == grand_b:
                t = 1
                r = 1
            else:
                gga = grand_a.get_parent
                ggb = grand_b.get_parent
                if gga == ggb:
                    t =2
                    r =2
                else:
