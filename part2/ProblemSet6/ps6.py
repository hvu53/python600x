...
##           ]
    ...
    for i in params:
        if triggerType == 'TITLE':
            triggerMap[name] = TitleTrigger(i)
            return TitleTrigger(i)
            
        elif triggerType == 'SUBJECT':
            triggerMap[name] = SubjectTrigger(i)
            return SubjectTrigger(i)
        elif triggerType == 'SUMMARY':
            triggerMap[name] = SummaryTrigger(i)
            return SummaryTrigger(i)

        elif triggerType == 'NOT':
            triggerMap[name] = NotTrigger(triggerMap[i])
            return NotTrigger(triggerMap[i])
    ...
    if triggerType == 'PHRASE':
        ...
        return PhraseTrigger(phrase)
           
##    if triggerType == 'AND':
##        return AndTrigger(triggerMap[params[0]], triggerMap[params[1]])
#AndTrigger(triggerMap[params[0]], triggerMap[params[1]])
