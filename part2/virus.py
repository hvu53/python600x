...
##                if self.isResistantTo(newDrug):
                    
        # after a prescription is aded, the drug acts on the virus populatio
        #virus_list = self.getTotalPop
    ...
    def update(self):
        ...
        for j in self.viruses:
            ...
            try:
                spawn= j.reproduce(density,self.getPrescriptions())
                virus_spawn.append(spawn)
            except NoChildException:
                pass
            
        for k in virus_spawn:
